...
class BackupDataSource:
    ...
    def fetch_url(url, timeout=20, max_retries=5):
        ...
        for attempt in range(max_retries):
            try:
                ...
                result = subprocess.run(
                    ['curl', '-s', '--connect-timeout', str(timeout), '-m', str(timeout + 5), url],
                    capture_output=True,
                    text=True,
                    timeout=timeout + 10
                )
                if result.returncode == 0 and result.stdout:
                    ...
                    print(f"curl请求失败(尝试{attempt+1}/{max_retries}): returncode={result.returncode}")
            except subprocess.TimeoutExpired:
                print(f"curl请求超时(尝试{attempt+1}/{max_retries}): {url}")
            except Exception as e:
                print(f"curl请求失败(尝试{attempt+1}/{max_retries}): {url}, 错误: {e}")
        ...
        try:
            response = requests.get(url, headers=BackupDataSource.HEADERS, timeout=timeout)
    ...
    GLOBAL_INDEX_MARKET = {
        # 港股指数 - 使用市场代码 100
        'HSI': '100', 'HSCEI': '100', 'HSTECH': '100', 
        'HSMEI': '100', 'HSCCI': '100', 'HSHKI': '100',
        # 美股指数 - 使用市场代码 100
        'NDX': '100', 'SPX': '100', 'DJI': '100', 
        'IXIC': '100', 'RUT': '100', 'VIX': '100',
        # 国际商品
        'GLNC': '100',  # 黄金
        'CLN': '100',   # 原油
    }
    ...
    def get_index_kline(index_code: str, count: int = 30) -> list:
        ...
        try:
            ...
            elif index_code.startswith('000') or index_code.startswith('880') or index_code.startswith('9'):
                market = '1'  # 上海
            ...
            print(f"获取指数K线: index_code={original_code}, normalized={index_code}, secid={secid}")
            ...
            if data.get('data') and data['data'].get('klines'):
                ...
                for i, item in enumerate(klines):
                    ...
                    if i > 0:  # 不是最早的那一天
                        ...
                        prev_close = float(prev_parts[2]) if len(prev_parts) > 2 else None
                ...
                print(f"指数K线获取成功: {len(result)}条记录, 最后一个change_percent={result[-1].get('change_percent') if result else None}")
                return result
        ...
        try:
            ...
            if df is not None and not df.empty:
                ...
                for r in records:
                    result.append({
                        'date': str(r.get('日期', '')),
                        'nav': float(r.get('单位净值', 0)) if r.get('单位净值') else None,
                        'accumulated_nav': float(r.get('累计净值', 0)) if r.get('累计净值') else None,
                        'daily_growth': float(r.get('涨跌幅', 0)) if r.get('涨跌幅') else None
                    })
                return result
        except Exception as e:
            ...
            if df is not None and not df.empty:
                ...
                for r in records:
                    result.append({
                        ...
                        'change_percent': float(r.get('涨跌幅', 0)) if r.get('涨跌幅') else None
                    })
                return result[::-1]
        except Exception as e:
...
def get_lof_tracking_index(fund_code: str) -> dict:
    ...
    lof_index_map = {
        ...
        '160222': {'index_code': '000932', 'index_name': '中证主要消费', 'coefficient': 0.95},
        
        # ============== 原油/能源 ==============
        '501018': {'index_code': 'CLU00', 'index_name': '原油期货', 'coefficient': 0.95},
        '161129': {'index_code': 'CLU00', 'index_name': '原油期货', 'coefficient': 0.95},
        '160416': {'index_code': 'CLU00', 'index_name': '原油期货', 'coefficient': 0.95},
        '160723': {'index_code': 'CLU00', 'index_name': '原油期货', 'coefficient': 0.95},
        ...
        '518800': {'index_code': 'AU9999', 'index_name': '黄金现货', 'coefficient': 0.99},
        ...
        '159741': {'index_code': 'HSTECH', 'index_name': '恒生科技', 'coefficient': 0.95},
        '30378': {'index_code': 'HSTECH', 'index_name': '恒生科技', 'coefficient': 0.95},
        '159825': {'index_code': 'HSCEI', 'index_name': '恒生国企', 'coefficient': 0.95},
        '501309': {'index_code': 'HSHKI', 'index_name': '港股通高股息', 'coefficient': 0.95},
        '501311': {'index_code': 'HSHKI', 'index_name': '港股通高股息', 'coefficient': 0.95},
        
        # ============== 美股指数 ==============
        '161130': {'index_code': 'NDX', 'index_name': '纳斯达克100', 'coefficient': 0.95},
        '159941': {'index_code': 'NDX', 'index_name': '纳斯达克100', 'coefficient': 0.95},
        '513100': {'index_code': 'NDX', 'index_name': '纳斯达克100', 'coefficient': 0.95},
        '513101': {'index_code': 'NDX', 'index_name': '纳斯达克100', 'coefficient': 0.95},
        ...
        '161122': {'index_code': '399989', 'index_name': '中证医疗', 'coefficient': 0.95},
        '162412': {'index_code': '399989', 'index_name': '中证医疗', 'coefficient': 0.95},
        '161727': {'index_code': '399989', 'index_name': '中证医疗', 'coefficient': 0.95},
        '160219': {'index_code': '399932', 'index_name': '中证医药', 'coefficient': 0.95},
        '161121': {'index_code': '399932', 'index_name': '中证医药', 'coefficient': 0.95},
        '512290': {'index_code': '399989', 'index_name': '中证医疗', 'coefficient': 0.95},
        '159938': {'index_code': '399932', 'index_name': '中证医药', 'coefficient': 0.95},
        '161036': {'index_code': '399989', 'index_name': '中证医疗', 'coefficient': 0.95},
        
        # ============== 新能源/光伏/电动车 ==============
        '161028': {'index_code': '399808', 'index_name': '中证新能源', 'coefficient': 0.95},
        '160225': {'index_code': '399808', 'index_name': '中证新能源', 'coefficient': 0.95},
        '161634': {'index_code': '399808', 'index_name': '中证新能源', 'coefficient': 0.95},
        '516160': {'index_code': '399808', 'index_name': '中证新能源', 'coefficient': 0.95},
        '159863': {'index_code': '931151', 'index_name': '中证光伏产业', 'coefficient': 0.95},
        '161728': {'index_code': '931151', 'index_name': '中证光伏产业', 'coefficient': 0.95},
        '161027': {'index_code': '399998', 'index_name': '中证新能源车', 'coefficient': 0.95},
        '159806': {'index_code': '399998', 'index_name': '中证新能源车', 'coefficient': 0.95},
        '515030': {'index_code': '399998', 'index_name': '中证新能源车', 'coefficient': 0.95},
        '516390': {'index_code': '399998', 'index_name': '中证新能源车', 'coefficient': 0.95},
        
        # ============== 军工/国防 ==============
        '161024': {'index_code': '399967', 'index_name': '中证军工', 'coefficient': 0.95},
        '161624': {'index_code': '399967', 'index_name': '中证军工', 'coefficient': 0.95},
        '512680': {'index_code': '399967', 'index_name': '中证军工', 'coefficient': 0.95},
        '160630': {'index_code': '399967', 'index_name': '中证军工', 'coefficient': 0.95},
        '502003': {'index_code': '399967', 'index_name': '中证军工', 'coefficient': 0.95},
        
        # ============== 证券/券商 ==============
        '161720': {'index_code': '399975', 'index_name': '中证全指证券公司', 'coefficient': 0.95},
        '161627': {'index_code': '399975', 'index_name': '中证全指证券公司', 'coefficient': 0.95},
        '160417': {'index_code': '399975', 'index_name': '中证全指证券公司', 'coefficient': 0.95},
        '160625': {'index_code': '399975', 'index_name': '中证全指证券公司', 'coefficient': 0.95},
        '512880': {'index_code': '399975', 'index_name': '中证全指证券公司', 'coefficient': 0.95},
        
        # ============== 银行/金融 ==============
        '161723': {'index_code': '399986', 'index_name': '中证银行', 'coefficient': 0.95},
        '160418': {'index_code': '399986', 'index_name': '中证银行', 'coefficient': 0.95},
        '512800': {'index_code': '399986', 'index_name': '中证银行', 'coefficient': 0.95},
        '161721': {'index_code': '000934', 'index_name': '中证800金融', 'coefficient': 0.95},
        
        # ============== 环保/低碳 ==============
        '161038': {'index_code': '000827', 'index_name': '中证环保', 'coefficient': 0.95},
        '160634': {'index_code': '000827', 'index_name': '中证环保', 'coefficient': 0.95},
        '161728': {'index_code': '931151', 'index_name': '中证光伏产业', 'coefficient': 0.95},
        '512580': {'index_code': '000827', 'index_name': '中证环保', 'coefficient': 0.95},
        
        # ============== 基建/地产 ==============
        '161726': {'index_code': '000022', 'index_name': '中证基建', 'coefficient': 0.95},
        '160224': {'index_code': '000022', 'index_name': '中证基建', 'coefficient': 0.95},
        '165525': {'index_code': '000022', 'index_name': '中证基建', 'coefficient': 0.95},
        '160628': {'index_code': '000022', 'index_name': '中证基建', 'coefficient': 0.95},
        '160218': {'index_code': '399393', 'index_name': '国证地产', 'coefficient': 0.95},
        '160208': {'index_code': '399393', 'index_name': '国证地产', 'coefficient': 0.95},
        '161724': {'index_code': '399393', 'index_name': '国证地产', 'coefficient': 0.95},
        
        # ============== 沪深300 ==============
        '161811': {'index_code': '000300', 'index_name': '沪深300', 'coefficient': 0.95},
        '160706': {'index_code': '000300', 'index_name': '沪深300', 'coefficient': 0.95},
        '160616': {'index_code': '000300', 'index_name': '沪深300', 'coefficient': 0.95},
        '510300': {'index_code': '000300', 'index_name': '沪深300', 'coefficient': 0.95},
        '159919': {'index_code': '000300', 'index_name': '沪深300', 'coefficient': 0.95},
        
        # ============== 中证500 ==============
        '161717': {'index_code': '000905', 'index_name': '中证500', 'coefficient': 0.95},
        '160617': {'index_code': '000905', 'index_name': '中证500', 'coefficient': 0.95},
        '510500': {'index_code': '000905', 'index_name': '中证500', 'coefficient': 0.95},
        '159922': {'index_code': '000905', 'index_name': '中证500', 'coefficient': 0.95},
        
        # ============== 创业板 ==============
        '161913': {'index_code': '399006', 'index_name': '创业板指', 'coefficient': 0.95},
        '159952': {'index_code': '399006', 'index_name': '创业板指', 'coefficient': 0.95},
        '160420': {'index_code': '399006', 'index_name': '创业板指', 'coefficient': 0.95},
        '160637': {'index_code': '399006', 'index_name': '创业板指', 'coefficient': 0.95},
        ...
        # ============== 有色金属/资源 ==============
        '160620': {'index_code': '000979', 'index_name': '有色金属', 'coefficient': 0.95},
        '160621': {'index_code': '000979', 'index_name': '有色金属', 'coefficient': 0.95},
        '512400': {'index_code': '000979', 'index_name': '有色金属', 'coefficient': 0.95},
        '160622': {'index_code': '399435', 'index_name': '国证有色', 'coefficient': 0.95},
        '160221': {'index_code': '000979', 'index_name': '有色金属', 'coefficient': 0.95},
        
        # ============== 信息安全/科技 ==============
        '161632': {'index_code': '399994', 'index_name': '信息安全', 'coefficient': 0.95},
        '159737': {'index_code': '399994', 'index_name': '信息安全', 'coefficient': 0.95},
        '512480': {'index_code': '399994', 'index_name': '信息安全', 'coefficient': 0.95},
        '161031': {'index_code': '399971', 'index_name': '中证传媒', 'coefficient': 0.95},
        
        # ============== 传媒/游戏 ==============
        '161729': {'index_code': '399971', 'index_name': '中证传媒', 'coefficient': 0.95},
        '160629': {'index_code': '399971', 'index_name': '中证传媒', 'coefficient': 0.95},
        '159805': {'index_code': '399971', 'index_name': '中证传媒', 'coefficient': 0.95},
        
        # ============== 半导体/芯片 ==============
        '512480': {'index_code': '399994', 'index_name': '信息安全', 'coefficient': 0.95},
        '159813': {'index_code': '930998', 'index_name': '中证芯片', 'coefficient': 0.95},
        '512760': {'index_code': '930998', 'index_name': '中证芯片', 'coefficient': 0.95},
        '159995': {'index_code': '930998', 'index_name': '中证芯片', 'coefficient': 0.95},
        '159801': {'index_code': '930998', 'index_name': '中证芯片', 'coefficient': 0.95},
        
        # ============== 互联网/中概 ==============
        '164906': {'index_code': 'H11136', 'index_name': '中国互联网50', 'coefficient': 0.95},
        '159607': {'index_code': 'H11136', 'index_name': '中国互联网50', 'coefficient': 0.95},
        '513050': {'index_code': 'H11136', 'index_name': '中国互联网50', 'coefficient': 0.95},
        '164805': {'index_code': 'H30533', 'index_name': '中国互联网', 'coefficient': 0.95},
        '165513': {'index_code': 'H30533', 'index_name': '中国互联网', 'coefficient': 0.95},
        
        # ============== 5G/通信 ==============
        '161726': {'index_code': '931079', 'index_name': '中证5G通信', 'coefficient': 0.95},
        '159994': {'index_code': '931079', 'index_name': '中证5G通信', 'coefficient': 0.95},
        '515050': {'index_code': '931079', 'index_name': '中证5G通信', 'coefficient': 0.95},
        '161825': {'index_code': '931079', 'index_name': '中证5G通信', 'coefficient': 0.95},
        
        # ============== 人工智能 ==============
        '159819': {'index_code': '931071', 'index_name': '中证人工智能', 'coefficient': 0.95},
        '515070': {'index_code': '931071', 'index_name': '中证人工智能', 'coefficient': 0.95},
        '161631': {'index_code': '931071', 'index_name': '中证人工智能', 'coefficient': 0.95},
        
        # ============== 煤炭/采掘 ==============
        '161724': {'index_code': '399998', 'index_name': '中证煤炭', 'coefficient': 0.95},
        '161032': {'index_code': '399998', 'index_name': '中证煤炭', 'coefficient': 0.95},
        '515220': {'index_code': '399998', 'index_name': '中证煤炭', 'coefficient': 0.95},
        
        # ============== 钢铁 ==============
        '160632': {'index_code': '930606', 'index_name': '中证钢铁', 'coefficient': 0.95},
        '512560': {'index_code': '930606', 'index_name': '中证钢铁', 'coefficient': 0.95},
        
        # ============== 银华系列 ==============
        '161810': {'index_code': '000300', 'index_name': '沪深300', 'coefficient': 0.95},
        '161812': {'index_code': '000300', 'index_name': '沪深300', 'coefficient': 0.95},
        '161816': {'index_code': '000300', 'index_name': '沪深300', 'coefficient': 0.95},
        
        # ============== 国泰系列 ==============
        '160212': {'index_code': '000300', 'index_name': '沪深300', 'coefficient': 0.95},
        '160213': {'index_code': '000905', 'index_name': '中证500', 'coefficient': 0.95},
        '160215': {'index_code': '000300', 'index_name': '沪深300', 'coefficient': 0.95},
        
        # ============== 华夏系列 ==============
        '160311': {'index_code': '000300', 'index_name': '沪深300', 'coefficient': 0.95},
        '160312': {'index_code': '000300', 'index_name': '沪深300', 'coefficient': 0.95},
        '160314': {'index_code': '000905', 'index_name': '中证500', 'coefficient': 0.95},
        '160317': {'index_code': '399006', 'index_name': '创业板指', 'coefficient': 0.95},
        
        # ============== 南方系列 ==============
        '160105': {'index_code': '000300', 'index_name': '沪深300', 'coefficient': 0.95},
        '160106': {'index_code': '000905', 'index_name': '中证500', 'coefficient': 0.95},
        '160119': {'index_code': '399006', 'index_name': '创业板指', 'coefficient': 0.95},
        '160131': {'index_code': '399006', 'index_name': '创业板指', 'coefficient': 0.95},
    }
    
    return lof_index_map.get(fund_code, {'index_code': None, 'index_name': '未知', 'coefficient': 0.95})
...
def api_indexes():
    ...
    if category:
        return jsonify({
            'category': category,
            'indexes': SUPPORTED_INDEXES.get(category, [])
        })
